...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentHolder> {
    ...
    Context context;
    List<com.example.calldatafromapi.Comment> commentList;

    public CommentAdapter(Context context , List<com.example.calldatafromapi.Comment> commentList){
    ...
    public void onBindViewHolder(@NonNull CommentHolder holder, int position) {
        ...
        com.example.calldatafromapi.Comment comment = commentList.get(position);
